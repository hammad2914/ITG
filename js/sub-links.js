...
(function (once, $) {
  ...
  const getSvgDoc = (e) => {
    return e.querySelector('[data-slider-wheel-image]').contentDocument;
  };
  ...
  function attach(context) {
    ...
    const setActiveIcon = (component, slide) => {
      ...
      if (svgDoc) {
        const activationElements = svgDoc.querySelectorAll('.activation');
    
        activationElements.forEach(element => {
          const dataSlide = element.getAttribute('data-slider-wheel-slide');
          
    
          if (dataSlide === slide.toString()) {
